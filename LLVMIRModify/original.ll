...
entry:
  ...
  %i = bitcast %"class.std::basic_ostream"* %call3 to i8**
  ...
  %i2 = bitcast %"class.std::basic_ostream"* %call3 to i8*
  %_M_ctype.i.idx.i = add nsw i64 %vbase.offset.i, 240
  %_M_ctype.i.i = getelementptr inbounds i8, i8* %i2, i64 %_M_ctype.i.idx.i
...
!2 = !{!"clang version 13.0.1 (https://github.com/llvm/llvm-project 75e33f71c2dae584b13a7d1186ae0a038ba98838)"}
!3 = !{!4, !4, i64 0}
